...
//#define TRAIT_CROPSHARE "Cropshare" //Mint Rework i
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_ALDERMAN = span_info("Alderman of the Assembly, voice of the respectable citizenry of Emerald Summit. Upon my charter I may spend the Crown's Purse and commission the realm's defense within the bounds the Commons have set me."),
	...
	TRAIT_GUARDSMAN = span_info("I am vigilant in my duties. In the town of Emerald Summit, my abilities are sharper due to my routine and familiarity."),
	TRAIT_GUARDSMAN_NOBLE = span_info ("I am vigilant in my duties. In the Keep of Emerald Summit, my abilities are sharper due to my routine and familiarity."),
	TRAIT_WOODSMAN = span_info("I am vigilant in my duties. In the grove and coast of Emerald Summit, my abilities are sharper due to my routine and familiarity."),
	...
	TRAIT_SILVER_BLOOD = span_info("My blood has been blessed with silver, burning any deadite that tries to feed on me. It will not protect me from their curse, however."),
