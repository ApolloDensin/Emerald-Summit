...
#define BLOCKADE_REPLENISH_BUDGET_PER_PLAYER 0.02
#define BLOCKADE_REPLENISH_BUDGET_MAX 2
#define BLOCKADE_REPLENISH_FIRST_DAY 2
#define BLOCKADE_REPLENISH_LAST_DAY 5
#define BLOCKADE_REPLENISH_DAILY_CHANCE 50
...
// TODO: Port AP #7632 - reduce quest/bounty rewards by 25% (QUEST_REWARD_MULT 0.75)
