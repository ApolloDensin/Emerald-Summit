...
/datum/controller/subsystem/economy/Initialize()
	...
	// Wire up trade_good_id -> roguestock lookup for standing order fulfillment.
	for(var/datum/roguestock/S as anything in SStreasury.stockpile_datums)
		if(S.trade_good_id)
			SStreasury.stockpile_by_trade_good[S.trade_good_id] = S
	roundstart_events()
