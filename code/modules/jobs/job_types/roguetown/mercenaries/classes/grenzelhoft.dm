...
/datum/advclass/mercenary/grenzelhoft_mage
		...
		traits_applied = list(TRAIT_INTELLECTUAL, TRAIT_STEELHEARTED, TRAIT_TALENTED_ALCHEMIST, TRAIT_ARCYNE_T4)
		mage_aspect_config = list("major" = 1, "minor" = 2, "utilities" = 6, "variants" = list(/datum/magic_aspect/pyromancy = "grenzelhoftian"), "ward" = TRUE)
		subclass_stats = list(
			STATKEY_INT = 3,
			STATKEY_WIL = 3,
			STATKEY_STR = -1,
...
/datum/outfit/job/roguetown/mercenary/grenzelhoft_mage/pre_equip(mob/living/carbon/human/H)
	...
	backl = /obj/item/rogueweapon/woodstaff/implement_magi2/grand
	...
	backpack_contents = list(
		...
		/obj/item/rogueweapon/huntingknife = 1,
		/obj/item/rogueweapon/scabbard/sheath = 1,
		/obj/item/book/magi2_grimoire = 1,
