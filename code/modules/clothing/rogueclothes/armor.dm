...
/obj/item/clothing/suit/roguetown/armor/leather/studded/warden
	...
	desc = "A hardened leather harness with a large pauldron worn over a maille coat, associated with the Emerald Summit wardens."
	body_parts_covered = COVERAGE_ALL_BUT_LEGS
...
// Ported from RW1710. RW parents this under their gilbranze "ancient plate" line, which ES lacks.
/obj/item/clothing/suit/roguetown/armor/plate/aalloy/artificer
	name = "artificed half-plate"
	desc = "Forbidden knowledge, resurrected into a weightless vessel of ancient alloy and magicka. It holds a slot for an arcyne meld to power it."
	smeltresult = /obj/item/ingot/aaslag
	icon_state = "artificerplate"
	item_state = "artificerplate"
	max_integrity = 500
	armor_class = ARMOR_CLASS_LIGHT // Artificer made.
	var/powered = FALSE
	var/mode = 1
...
/obj/item/clothing/suit/roguetown/armor/plate/aalloy/artificer/Initialize(mapload)
	.=..()
	update_description()

/obj/item/clothing/suit/roguetown/armor/plate/aalloy/artificer/attackby(obj/item/I, mob/user, params)
...
/obj/item/clothing/suit/roguetown/armor/plate/aalloy/artificer/proc/toggle_mode(mob/user)
	if(!src.ontable())
...
/obj/item/clothing/suit/roguetown/armor/plate/aalloy/artificer/equipped(mob/living/user, slot)
	. = ..()
...
/obj/item/clothing/suit/roguetown/armor/plate/aalloy/artificer/dropped(mob/living/user)
	.=..()
	if(active_item)
		if(mode == 1)
...
/obj/item/clothing/suit/roguetown/armor/plate/aalloy/artificer/proc/update_description()
	if(mode == 1)
		desc = "Forbidden knowledge, resurrected into a weightless vessel of ancient alloy and magicka. It crackles with raw magicka; the mind, empowered."
	else
		desc = "Forbidden knowledge, resurrected into a weightless vessel of ancient alloy and magicka. It crackles with arcyne vigor; the body, emboldened."
...
/obj/item/clothing/suit/roguetown/armor/champion
	...
	desc = "A coat with plates specifically tailored and forged for the champion of Emerald Summit."
