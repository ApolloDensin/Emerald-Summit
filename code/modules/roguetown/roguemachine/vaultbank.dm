...
/obj/structure/roguemachine/vaultbank
	...
	desc = "A biomechanical obelisk that collects and secures the treasury of the Grand Duchy of Emerald Summit. Throttle it with a strike to spill that which is rightfully yours."
...
// ============================================================================
// MEISTER PANEL PROCS (Step 16 - Meister Panel tgui)
// ============================================================================
